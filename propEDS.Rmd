...
# Baseline proprioceptive accuracy and precision
...
- there is a difference between EDS and control in the explicit (with strategy) reach aftereffects, which may be due to an uncharacteristic control group (cf. Modchalingam et al., 2019)
- the EDS and control group shifted their localization responses equally

So far, these are just checks to see if the experiment worked.

- the EDS group was less precise in hand localization compared to the control group, except perhaps in the aligned/active condition
